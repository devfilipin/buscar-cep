...
public class Sobre extends JDialog {
	...
	public Sobre() {
		...
		JLabel lblNewLabel_1 = new JLabel("Daniela Filipin");
		...
		btnTutorial.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				link("https://www.instagram.com/danifilipin/");
			}
		});
		btnTutorial.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		btnTutorial.setIcon(new ImageIcon(Sobre.class.getResource("/img/instagram.png")));
		btnTutorial.setToolTipText("Instagram");
